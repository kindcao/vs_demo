...
{/// <summary>  
    ...
    public static class OracleHelper
    {
        ...
        public static string connstr = ConfigurationManager.ConnectionStrings["connstr"].ToString(); //"data source=192.168.10.10/orcl;User Id=user01;Password=user01;";
        ...
        public static OracleConnection getConn(string connectionString)
        {
            ...
            if (conn == null)
                throw new ArgumentException("当前数据库连接不存在");
